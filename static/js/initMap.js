...
export default locations => {
	...
	function build_listener(loc, marker) {
		return pushRoute => {
			infowindow.setContent('<div class="infowindow-content" data-slug="'+loc.slug+'"><p><span class="title">'+loc.title+'</span>'+loc.date+'<br>'+loc.time+'</p><div class="soundcloud"><iframe width="100%" height="20" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/'+loc.id+'&amp;color=ff9900&amp;inverse=false&amp;auto_play=false&amp;show_user=false"></iframe><div class="la-ball-clip-rotate small loader"><div></div></div></div></div>')
